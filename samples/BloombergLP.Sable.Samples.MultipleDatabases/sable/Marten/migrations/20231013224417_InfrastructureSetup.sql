...
DO $$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM  books.__sable_migrations WHERE migration_id = '20231013224417_InfrastructureSetup') THEN

        RAISE NOTICE 'Inserting record for migration with Id = 20231013224417_InfrastructureSetup';

        INSERT INTO books.__sable_migrations (migration_id, backfilled)
        VALUES ('20231013224417_InfrastructureSetup', '0');
    END IF;
END $$;
